...
function KeyPad(props) {
    return (
        <div className="calculator-keys">
            ...
            <button name="C" class="all-clear" onClick={e => { props.onClick(e.target.name) }}>C</button>
            ...
            <button name="." className="decimal" onClick={e => { props.onClick(e.target.name) }}>.</button>
            <button name="0" onClick={e => { props.onClick(e.target.name) }}>0</button>
            <button name="=" className="equal-sign" onClick={e => { props.onClick(e.target.name) }}>=</button>
            <button name="/" className="operator" onClick={e => { props.onClick(e.target.name) }}>/</button>
        </div>
    );
}
